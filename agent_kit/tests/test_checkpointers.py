...
from agent_core.state import RUN_STATE_SCHEMA_VERSION, UnknownSchemaVersionError
    ...
    def test_runtime_pause_save_resume_in_new_runtime(self):
        ...
        async def go():
            ...
            def guard(decision, state):
                from agent_core import GuardResult
                return GuardResult(requires_approval=True, reason="emails to CEO need approval")

            from agent_core import Harness, ValidationResult
            harness = Harness(
